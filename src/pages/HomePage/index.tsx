...
export default function HomePage() {
  ...
  return (
    <main className="flex flex-col items-center justify-center px-4 py-36 text-center mx-auto">
      {/* Hero Section */}
      ...
      <img
        ...
        className={`w-full max-w-4xl rounded-lg shadow-md mb-16 transform transition-opacity duration-1000 ease-in-out ${
          isVisible ? "opacity-100 translate-y-0 animate-fade-in" : "opacity-0 translate-y-6"
        }`}
      />
      {/* How It Works */}
      <section className="mb-16 w-full max-w-4xl">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          { [
            ...
            <Card key={i} className="border border-black bg-white p-6">
